        ...
        <div className="p-6 pb-0">
          <div className="flex justify-between text-[#28C76F] items-center gap-3">
            <div className="flex gap-3 items-center">
              <svg
                className="bg-[#FFF1E3] w-9 h-9 rounded text-[#FF9F43] px-[8px] py-[8px]"
                fill="currentColor"
                strokeWidth="1"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 320 512"
              ...
              <div className="-mt-[8px]">
                <h5 className="text-[16px] text-[#5D596C] flex items-center">
                  <svg
                    className="w-[15px] h-[15px] mt-1 rounded"
                    fill="currentColor"
                    strokeWidth="0.5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 320 512"
                ...
                <h3 className=" items-center text-xs font-normal text-[#A5A3AE]">
                  Your Earnings
                </h3>
              </div>
            </div>
            <div>
              <h5 className="text-[#28C76F]">+10.2%</h5>
            </div>
          </div>
        </div>
        ...
        <div className="gap-y-6 pt-0 p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-5">
              ...
              <span className="text-[#EA5455]">-139.34</span>
            </div>
          </div>
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-5">
              ...
              <span className="text-[#28C76F]">+576.24</span>
            </div>
          </div>
        </div>
      </div>
